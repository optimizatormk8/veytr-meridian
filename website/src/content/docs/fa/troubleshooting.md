...
**راه‌حل:** به v3.6.0+ به‌روزرسانی کنید. XHTTP اکنون روی پورت localhost اجرا و از طریق Caddy مسیریابی می‌شود.
...
| پورت‌های در حال گوش دادن | پورت 443 باید haproxy نشان دهد. اگر نیست، پروکسی اجرا نمی‌شود |
...
| Domain HTTPS | Caddy + HAProxy کار می‌کنند | مشکل DNS، Caddy یا HAProxy |
