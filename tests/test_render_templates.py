...
MOCK_VARS: dict[str, object] = {
    ...
    "vless_xhttp_url": "vless://test-uuid@1.2.3.4:443?encryption=none&security=tls&sni=1.2.3.4&fp=chrome&type=xhttp&path=%2Ftestxhttp&mode=auto&host=1.2.3.4#Test-XHTTP",
